      ...
      <React.Fragment>
        <article className="container-cloud">
          <section className="cloud1">
            <img src={Cloud1} alt="second cloud" />
          </section>
          <section>
            <img src={Cloud2} alt="third cloud" />
          </section>
          ...
          <section className="cloud5">
            <img src={Cloud3} alt="second cloud" />
          </section>
          ...
          <article className="home-style">
            <section className="music">
              ...
              <p>
                ...
                addiction. These studies found a biological explanation for why
                music always has been such a huge part of emotional events
                around the world since the beginning of human history.
              </p>
              <p>
                ...
                due mainly to an emotional attachment to a memory associated
                with the song.
              </p>
              <h3>
